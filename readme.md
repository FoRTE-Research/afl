...
This repository contains several modified versions of [AFL](http://lcamtuf.coredump.cx/afl) components which we utilize in our experiments on fixed (pre-generated) fuzzing input datasets: 
